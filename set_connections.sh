...
#
airflow connections add aws_credentials --conn-uri 'aws://AKIARONRSPPFS6YR67B7:rTrSpzsZyIf61oxLH0qsAA%2BqZlp4iStUR807vdp6@'
#
#
# TO-DO: run the follwing command and observe the JSON output: 
...
# TO-DO: Update the following command with the URI and un-comment it:
#
airflow connections add redshift --conn-uri 'redshift://admin:fkdlTm90%21@default.238975189030.us-east-1.redshift-serverless.amazonaws.com:5439/dev'
#
# TO-DO: update the following bucket name to match the name of your S3 bucket and un-comment it:
#
airflow variables set s3_bucket jin-udacity
#
